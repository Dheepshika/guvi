    ...
    <h1>Sign In / Register</h1>
            ...
            <div class="welcome-container">
                <h1 class="welcome-heading">GUVI</h1>
                    <p class="welcome-quote">""Embrace Knowledge Today, Empower Leadership Tomorrow""</p>
            </div>
...
<div class="login-text">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" name="FullName" placeholder="Enter your namr">
    </div>
    <div class="mb-3">
